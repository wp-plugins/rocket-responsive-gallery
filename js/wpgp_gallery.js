jQuery(function ($) {
	...
	$('#add_slide_button').click(function() {
		...
		var caption_name_attr = 'slides[' + slide_id + '][caption]';
		var alt_name_attr = 'slides[' + slide_id + '][alt]';
		var link_name_attr = 'slides[' + slide_id + '][link]';
		...
		$('#new_slide_template .slide_alt_input').attr('data-id', slide_id);

		$('#new_slide_template .slide_caption_input').attr('data-id', slide_id);

		$('#new_slide_template .slide_link_input').attr('data-id', slide_id);
		...
		$('#new_slide_template .slide_alt_input').attr('name', alt_name_attr);

		$('#new_slide_template .slide_caption_input').attr('name', caption_name_attr);

		$('#new_slide_template .slide_link_input').attr('name', link_name_attr);
		...
		$('#new_slide_template .slide_caption_input').attr('name', '');
		$('#new_slide_template .slide_alt_input').attr('name', '');
		$('#new_slide_template .slide_link_input').attr('name', '');
		...
		$('#new_slide_template .slide_image_preview').html('');
	...
	window.send_to_editor = function(html) {
		...
		if ( is_slide_add_image ) {
			...
			$(attachment_input).val(image_url);
	...
	if ( pagenow == 'edit-wpgp_gallery' ) {
		
		$('.add-new-h2').addClass('wpgp-button');
		(function($){
			$('#wpbody .wrap').wrapInner('<div id="wpgp-col-left" />');
			$('#wpbody .wrap').wrapInner('<div id="wpgp-cols" />');
			$('#wpgp-col-right').removeClass('hidden').prependTo('#wpgp-cols');
			
			$('#wpgp-col-left > .icon32').insertBefore('#wpgp-cols');
			$('#wpgp-col-left > h2').insertBefore('#wpgp-cols');
		})(jQuery);

	}

	if ( pagenow == 'wpgp_gallery' )
		$('.add-new-h2').hide();
